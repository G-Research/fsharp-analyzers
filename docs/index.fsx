(*** hide ***)
#r "../src/FSharp.Analyzers/bin/Release/net10.0/FSharp.Compiler.Service.dll"
#r "../src/FSharp.Analyzers/bin/Release/net10.0/FSharp.Analyzers.SDK.dll"
#r "../src/FSharp.Analyzers/bin/Release/net10.0/G-Research.FSharp.Analyzers.dll"
